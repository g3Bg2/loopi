  ...
  return (
    <div className="p-6 space-y-6">
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-muted-foreground">
              Securely manage your automation credentials
            </p>
          </div>
        </div>
      ...
      <Alert>
        ...
        <AlertDescription>
          All credentials are encrypted and stored securely. They are only
          decrypted during automation execution and never exposed in logs.
        </AlertDescription>
      </Alert>
              ...
              <Card key={credential.id}>
                ...
                <CardContent>
                  <div className="space-y-3">
                    {Object.entries(credential.encryptedValues).map(
                      ([field, value]) => {
                        ...
                        return (
                          ...
                          >
                            ...
                            <Button
                              ...
                              size="sm"
                              onClick={() =>
                                toggleShowValue(credential.id, field)
                              }
                            >
                              {isVisible ? (
